...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-hero relative">
      ...
      {/* Hero Section */}
      <section className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-24 sm:pt-24 sm:pb-32">
      ...
      {/* Approach Section */}
      <section id="approach" className="relative z-10 max-w-6xl mx-auto px-6 py-24 sm:py-32">
      ...
      {/* Process Section */}
      <section className="relative z-10 bg-cream-50/50 py-24 sm:py-32">
        <div className="max-w-6xl mx-auto px-6">
