...
export default function DashboardPage() {
  ...
  async function loadPlans() {
    try {
      ...
      const allPlans = await storage.listPlans('dev-user-local');
  ...
  async function handleArchivePlan(id: string) {
    ...
    await storage.updatePlan(id, { status: newStatus });
  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      ...
      {/* Header */}
      <header className="relative z-10 border-b border-stone-200/60 bg-white/80 backdrop-blur-sm sticky top-0">
