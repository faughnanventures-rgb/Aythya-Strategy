...
// ============================================
// SUPABASE ADAPTER (Placeholder for Phase 2)
// ============================================

// This will be implemented when transitioning to Supabase
// For now, it throws errors to ensure we don't accidentally use it
const supabaseAdapter: StorageAdapter = {
  async createPlan(): Promise<StrategicPlan> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
  async getPlan(): Promise<StrategicPlan | null> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
  async updatePlan(): Promise<StrategicPlan> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
  async deletePlan(): Promise<void> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
  async listPlans(): Promise<StrategicPlan[]> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
  async savePhaseData(): Promise<void> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
  async getPhaseData(): Promise<null> {
    throw new Error('Supabase adapter not implemented. Set NEXT_PUBLIC_STORAGE_MODE=local');
  },
