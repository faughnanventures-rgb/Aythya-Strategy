...
Start with visioning questions to unlock possibilities:
1. "If money was no object, what would you want to be doing with your life?"
2. "If you couldn't do what you're doing right now — it's just not an option — what would you do instead?"
...
**Opening with Visioning Questions:**

Start by unlocking possibilities before getting practical:

24. "If money was completely off the table — you have all you need — what would you want to be doing with your life?"
    - Let them dream. Don't immediately reality-check.
    - Listen for themes: creation, connection, impact, freedom, mastery.

25. "Here's a harder one: If you couldn't do what you're doing right now — it's just not an option anymore — what would you do instead?"
    - This reveals backup identities and hidden interests.
    - Often surfaces things they've suppressed or dismissed.

**Then ground it in reality:**

26. "Given those insights, what are the 2-3 focus areas that feel most important to you right now?"
...
27. "What does this pillar mean specifically for you?"
    - Make it personal, not generic.

28. "What's the current state of this pillar?"
    - Where are they starting from?

29. "What does progress look like here?"
